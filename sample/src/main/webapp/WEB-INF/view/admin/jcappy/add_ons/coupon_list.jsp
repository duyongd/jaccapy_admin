					...
					<div id="bbs">
						<div id="blist">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리목록입니다.">
								...
								<tbody>
									<tr>
										...
										<td>1</td>
										<td class="title"><a href="<%=request.getContextPath()%>/admin/jcappy/add_ons/coupon_view.do">여름특가vip쿠폰</a></td>
										<td>3000원</td>
										<td>2021-7-24</td>
										<td>Y</td>
							...
							<div class="btn">
								...
								<div class="btnRight">
									<a class="wbtn" href="<%=request.getContextPath()%>/admin/jcappy/add_ons/coupon_write.do"><strong>등록</strong> </a>
								</div>
							</div>
							<!--//btn-->
							<!-- 페이징 처리 -->
