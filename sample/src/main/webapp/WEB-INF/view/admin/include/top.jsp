...
<div id="header">
	<div class="header_inner">
		...
		<div id="menu">
  			<ul class="menu">
  				<li><a href="<%=request.getContextPath()%>/admin/member/index.do" class="parent"><span>상품관리</span></a></li>
				<li><a href="<%=request.getContextPath()%>/admin/jcappy/order/order_list.do" class="parent"><span>주문관리</span></a></li>
				<li><a href="<%=request.getContextPath()%>/admin/product/index.do" class="parent"><span>회원관리</span></a></li>
				<li><a href="<%=request.getContextPath()%>/admin/jcappy/board/review_list.do" class="parent"><span>게시판관리</span></a>
					<div class="standard_left">
					<ul>
						<li><a href="<%=request.getContextPath()%>/admin/jcappy/board/review_list.do"><span>리뷰</span></a></li>
						<li><a href="<%=request.getContextPath()%>/admin/jcappy/board/qna_list.do"><span>문의</span></a></li>
						<li><a href="<%=request.getContextPath()%>/admin/jcappy/board/notice_list.do"><span>공지</span></a></li>
					</ul>
					</div>
				</li>
				<li><a href="<%=request.getContextPath()%>/admin/jcappy/add_ons/add_ons.do" class="parent"><span>부가기능</span></a></li>
				<li><a href="<%=request.getContextPath()%>/admin/jcappy/lookUp_sales/lookUp_sales.do" class="parent"><span>매출조회</span></a></li>
				<li><a href="<%=request.getContextPath()%>/admin/admin/index.do" class="parent"><span>Admin</span></a></li>
			</ul>
		</div>
		<!--//gnb-->
	</div>
